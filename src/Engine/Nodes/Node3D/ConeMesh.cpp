...
ConeMesh::ConeMesh(float baseWidth, float baseHeight, float height, int resolution) {
...
float ConeMesh::BaseWidth() { return baseWidth; }

float ConeMesh::BaseHeight() { return baseHeight; }

float ConeMesh::Height() { return height; }

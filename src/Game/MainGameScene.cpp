...
Engine::Nodes::Node* MainGameScene::constructTree()
{
	...
	sun->material->shininess = 50;
	sun->material->specular = 1;
    sun->material->emission = 0.8;
	sun->Position(Vector3(0, 0, -500));
	sun->setName("Sun");
	root->addChild(sun);
    ...
    // SphereMesh* sun2 = new SphereMesh(200, 100);
    // sun2->material->color = Color(255, 255, 143, 255);
    // sun2->material->ambient_diffuse = 0.5;
    // sun2->material->shininess = 50;
    // sun2->material->specular = 1;
    // sun2->material->emission = 0.7;
    // sun2->Position(Vector3(300, 0, 300));
    // sun2->setName("Sun2");
    // root->addChild(sun2);
    // Light3D* sunLight2 = new Light3D();
    // sunLight2->color = Color::fromRGBInt(255, 218, 143, 1);
    // sunLight2->ambient = 0.2;
    // sunLight2->diffuse = 1;
    // sunLight2->specular = 1;
    // sunLight2->setName("SunLight2");
    // sun2->addChild(sunLight2);
	...
	cameraParent->Position(Vector3(0, 0, 0));
    // cameraParent->addChild(sunLight);
    ...
    camera2->setFOV(90);
    camera2->setFar(5000);
    camera2->Position(Vector3(0, 3000, -500));
